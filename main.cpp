...
vector <unsigned char> get_blocks(string message, int start, int end){
    vector <unsigned char> block[SIZE_BLOCK];
        ...
        switch (option){
            case '1': {
                ...
                for (int i = 0; i < number_of_blocks; i++){
                    block = get_blocks(message, i*SIZE_BLOCK, i*SIZE_BLOCK + SIZE_BLOCK);
                }
